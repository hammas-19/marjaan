    ...
    <section class="max-w-7xl mx-auto px-2 py-10">
      <div class="grid sm:grid-cols-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center md:gap-10 gap-1">
        ...
        <div
          ...
          <img src="/gridImages/Ibbo-X.jpg" class="object-cover h-full w-full"
            alt="Rechik Hoodies in stylish modern designs">
          <div
            ...
            <h1 class="md:text-4xl text-2xl font-headings font-bold text-white">Sweatshirts</h1>
            <span class="text-white md:text-lg text-sm">
              SweatShirts Done Right
            </span>
